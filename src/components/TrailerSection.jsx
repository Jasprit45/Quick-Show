    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
            {dummyTrailers.map((trailer)=>(
                <div key={trailer.image} className='relative group-hover:not-hover:opa590
                 hover:translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer' onClick={()=> setCurrentTrailer(trailer)}>
                    <img src={trailer.image} alt="trailers" className='rounder -lg w-full h-full object-cover brightness-75' />
