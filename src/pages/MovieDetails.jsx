...
const MovieDetails = () => {
  ...
  const {axios, getToken, user, shows, image_base_url , fetchFavoriteMovies, favoriteMovies } = useAppContext() ;
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col-2 md:flow-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center gap-24 text-gray-300'>
          ...
          <div className='flex items-center flex-wrap    gap-4 mt-4'>
            ...
            <a  href="#dateSelect" className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-95'>But Tickets</a>
      ...
      <p className='te-lg font-medium mt-20'>Your Favorite Cast</p>
